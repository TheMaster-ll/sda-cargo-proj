      ...
      <Box sx={{ py: 3, bgcolor: '#0f172a', color: '#94a3b8', px: 4 }}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 2 }}>
          ...
          <Box sx={{ display: 'flex', gap: 2 }}>
            <Typography variant="caption" component={Link} to="/privacy-policy" sx={{ color: '#94a3b8', textDecoration: 'none', '&:hover': { color: '#fff' } }}>Privacy Policy</Typography>
            <Typography variant="caption" component={Link} to="/terms-of-service" sx={{ color: '#fff', textDecoration: 'none' }}>Terms of Service</Typography>
          </Box>
        </Box>
      </Box>
    </Box>
